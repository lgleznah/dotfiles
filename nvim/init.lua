...
vim.keymap.set('n', '<C-Space>', 'viw')
vim.keymap.set('v', '<C-Space>', 'iw')
vim.keymap.set('v', 'ññ', '<ESC>')
vim.keymap.set('i', 'ñl', '<ESC>l%%a')
vim.keymap.set('n', 'ñl', 'l%%a')
vim.keymap.set('i', 'ñh', '<ESC>%i')
vim.keymap.set('v', '//', 'y/<C-R>"<CR>N')

-- Auto-parenthesis keymaps
